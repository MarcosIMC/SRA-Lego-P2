...
while True:
    ...
    if(not move_to_goal()):
        ...
        while(not dist): 
            move(-5, 30, True, True)
            times += 1
            dist = search_spin(30 + (times * 10), offset1=180, speed1=10, second_lap=True) 
    else:
        ...
        while(not dist):
            if times % 5 == 0 and times != 0:
                ...
                move(-5, 30, True, True)
                dist = search_spin(30 + (10 * times), offset1=40, speed1=10, second_lap=True)
                times += 1
    ...
    while(not hit_goal()):
        ...
        reset_motor()
        move(-5, 30, True, True)
        dist = search_spin(30 + (times * 10), offset1=45, speed1=10, second_lap=True, fast_exit=True)
        while (not dist):
            if(times % 5 == 0 and times != 0):
                dist = search_spin(30 + (times * 10), offset1=180, speed1=15, second_lap=True, fast_exit=True)
            else:
                # Búsqueda redundante
